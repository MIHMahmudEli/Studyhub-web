...
export default function NotificationBell() {
  ...
  return (
    <div className="relative" ref={dropdownRef}>
      ...
      {open && (
        <div className="absolute right-0 top-full mt-3 w-[380px] sm:w-[420px] bg-[var(--background)] border border-[var(--card-border)] rounded-2xl shadow-2xl overflow-hidden z-[9999] animate-in fade-in slide-in-from-top-2 duration-200">
          {/* Header */}
