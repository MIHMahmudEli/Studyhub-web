                  ...
                  <tr key={note.id} className="hover:bg-slate-500/5 transition-colors">
                    ...
                    <td className="py-5 px-4 text-center">
                      {note.status === 'approved' && (
                        <span className="inline-flex px-3 py-1 rounded-full text-[8px] font-black uppercase tracking-wider bg-emerald-500/10 border border-emerald-500/20 text-emerald-600 dark:text-emerald-500 bg-emerald-50 dark:bg-emerald-500/10 bg-emerald-50 dark:bg-emerald-500/10">
                          Approved
                        </span>
                      )}
                      {note.status === 'pending' && (
                        <span className="inline-flex px-3 py-1 rounded-full text-[8px] font-black uppercase tracking-wider bg-amber-500/10 border border-amber-500/20 text-amber-600 dark:text-amber-500 bg-amber-50 dark:bg-amber-500/10 bg-amber-50 dark:bg-amber-500/10">
                          Pending
                        </span>
                      )}
                      {note.status === 'rejected' && (
                        <span className="inline-flex px-3 py-1 rounded-full text-[8px] font-black uppercase tracking-wider bg-red-500/10 border border-red-500/20 text-red-600 dark:text-red-500 bg-red-50 dark:bg-red-500/10 bg-red-50 dark:bg-red-500/10">
                          Rejected
                        </span>
                      )}
                    </td>
