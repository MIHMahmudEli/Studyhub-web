...
import { UploadCloud, BookOpen, Bookmark, Trophy, ArrowRight, Layers } from 'lucide-react';
...
export default function QuickShortcuts() {
  ...
  return (
    <div className="space-y-6">
      ...
      <div className={`grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-${isAdminOrMod ? '5' : '4'} gap-4`}>
