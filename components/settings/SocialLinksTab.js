...
import { Github, Linkedin, Instagram, Facebook, Save, Link2, Trash2 } from 'lucide-react';
...
const SOCIAL_FIELDS = [
  ...
  { key: 'facebook', icon: Facebook, label: 'Facebook', placeholder: 'https://facebook.com/username', color: 'text-blue-700' },
];
