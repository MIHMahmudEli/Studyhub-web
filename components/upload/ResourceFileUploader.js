...
export default function ResourceFileUploader({ file, setFile, setStatus }) {
    ...
    >
      {file ? (
        <div className="animate-in zoom-in duration-500 w-full">
          ...
          <p className="text-[11px] font-black text-[var(--foreground)] uppercase tracking-widest truncate max-w-[220px] mx-auto mb-2">{file.name}</p>
        ...
        <>
          <div className="w-20 h-20 bg-blue-500/10 rounded-full flex items-center justify-center mx-auto mb-6 border border-blue-500/20 text-blue-500">
            <UploadCloud size={32} />
          </div>
          ...
          <button 
            ...
            className="px-6 py-3 rounded-xl bg-blue-500 text-white font-black text-[11px] uppercase tracking-widest hover:bg-blue-600 transition-all shadow-lg shadow-blue-500/20"
          >
            Browse Files
          </button>
        </>
