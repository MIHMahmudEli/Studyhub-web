  ...
  return (
    <div className={`relative ${widthClass}`}>
      ...
      <input
        ...
        className={`w-full bg-[var(--card-bg)] border border-[var(--card-border)] text-[var(--foreground)] rounded-2xl py-3.5 pl-12 pr-6 text-[10px] font-black tracking-widest uppercase focus:outline-none ${focusBorderClass} transition-all shadow-xl`}
        value={value}
        onChange={onChange}
      />
    </div>
