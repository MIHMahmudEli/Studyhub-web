                ...
                <div key={group.subject}>
                  ...
                  {isOpen && (
                    <div className="bg-white/[0.015] border-t border-[var(--card-border)]">
                      <div className="px-5 sm:px-7 py-2 hidden sm:grid grid-cols-[1fr_1fr_auto_auto] gap-4 items-center">
                        {['File Name', 'Author', 'Downloads', 'Rating'].map(h => (
                      ...
                      {group.resources.map((resource) => (
                        <div
                          key={resource.id}
                          className="px-5 sm:px-7 py-3 flex sm:grid sm:grid-cols-[1fr_1fr_auto_auto] gap-3 sm:gap-4 items-center hover:bg-white/[0.02] transition-colors border-t border-[var(--card-border)]/50"
                        >
                          <div className="flex-1 min-w-0 sm:contents">
                            <p className="text-[10px] sm:text-[11px] font-bold truncate text-[var(--foreground)] pl-3 sm:pl-0" title={resource.title}>
                              {resource.title}
                            </p>
