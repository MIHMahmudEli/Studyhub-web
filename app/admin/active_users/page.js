            ...
            <>
              ...
              >
                ...
                <div className="block md:hidden space-y-4">
                  {dailyUsers.map(u => <UserCard key={u.id} user={u} showActiveTime showDept={false} showPlatform />)}
                </div>
          ...
          {mode === 'live' && (
            <>
              ...
              >
                ...
                <div className="block md:hidden space-y-4">
                  {liveUsers.map(u => <UserCard key={u.id} user={u} showActiveTime isLive showDept={false} showPlatform />)}
                </div>
              </AdminPanel>
            </>
          )}
