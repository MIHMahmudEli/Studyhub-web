...
import {
  ...
  Trophy, Github, Linkedin, Instagram, Facebook, ExternalLink, Shield
} from 'lucide-react';
...
const SOCIAL_ICONS = [
  { key: 'github', icon: Github, href: (v) => v, color: 'hover:text-gray-800 dark:hover:text-gray-200' },
  ...
  { key: 'facebook', icon: Facebook, href: (v) => v, color: 'hover:text-blue-700' },
];
